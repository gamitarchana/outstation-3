...
class OutstationRoutePage(MetadataPageMixin, PageLDMixin, Page):
    ...
    origin_display_name = RichTextField(null = True, blank = True, features = ['h1','h2', 'h3', 'h4', 'h5', 'h6'])
    ...
    destination_display_name = RichTextField(null = True, blank = True, features = ['h1','h2', 'h3', 'h4', 'h5', 'h6'])
